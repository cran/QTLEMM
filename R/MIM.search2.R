...
#' @param y vector. An vector that contains the phenotype values of
#' individuals with genotyped.
#' @param yu vector. An vector that contains the phenotype value
...
MIM.search2 <- function(QTL, marker, geno, y, yu = NULL, sele.g = "n", tL = NULL, tR = NULL, method = "EM",
                        type = "RI", D.matrix = NULL, ng = 2, cM = TRUE, speed = 1, QTLdist = 15, conv = 10^-3,
                        console = TRUE){
